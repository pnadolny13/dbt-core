...
class ProjectFlags(ExtensibleDbtClassMixin):
    ...
    require_mf_time_spines_with_yaml_configuration: bool = False
    ...
    def project_only_flags(self) -> Dict[str, Any]:
        return {
            ...
            "require_mf_time_spines_with_yaml_configuration": self.require_mf_time_spines_with_yaml_configuration,
        }
